//
//  CreativePadExtensionDSPKernel.hpp
...
#import "CreativePadExtension-Swift.h"
#import "CreativePadExtensionParameterAddresses.h"

/*
 CreativePadExtensionDSPKernel
 As a non-ObjC class, this is safe to use from render thread.
 */
class CreativePadExtensionDSPKernel {
public:
    ...
    void setParameter(AUParameterAddress address, AUValue value) {
        switch (address) {
            case CreativePadExtensionParameterAddress::gain:
                mGain = value;
                break;
                // Add a case for each parameter in CreativePadExtensionParameterAddresses.h
        }
    }
    ...
    void process(std::span<float const*> inputBuffers, std::span<float *> outputBuffers, AUEventSampleTime bufferStartTime, AUAudioFrameCount frameCount) {
        /*
         ...
         modify the check in [CreativePadExtensionAudioUnit allocateRenderResourcesAndReturnError]
         */
