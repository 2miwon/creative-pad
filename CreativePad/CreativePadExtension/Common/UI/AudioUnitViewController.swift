...
private let log = Logger(subsystem: "wwdc2024.CreativePadExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<CreativePadExtensionMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try CreativePadExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? CreativePadExtensionAudioUnit else {
            log.error("Unable to create CreativePadExtensionAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(CreativePadExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = CreativePadExtensionMainView(parameterTree: observableParameterTree)
