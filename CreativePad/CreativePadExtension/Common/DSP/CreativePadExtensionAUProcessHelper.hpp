//
//  CreativePadExtensionAUProcessHelper.hpp
...
#include <vector>
#include "CreativePadExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(CreativePadExtensionDSPKernel& kernel, UInt32 inputChannelCount, UInt32 outputChannelCount)
    : mKernel{kernel},
...
private:
    CreativePadExtensionDSPKernel& mKernel;
